...
public class OrientationMngr {
    ...
    public interface OnChangedListener {
         ...
         */
        void onOrientationChanged(OrientationMngr orientationManager);
         ...
         * @param orientationManager the orientation manager that detected the change
         */
        void onLocationChanged(OrientationMngr orientationManager);
         ...
         * @param orientationManager the orientation manager that detected the change
         */
        void onAccuracyChanged(OrientationMngr orientationManager);
    }
     ...
     */
    public OrientationMngr(SensorManager sensorManager, LocationManager locationManager) {
